    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-volume-up"></i> Announcement
        </div>
        <div class="card-body">
            <form method="POSt">
                <?php
            ...
            <div class="form-group">
                <div class="form-row">
                <div class="col-md-6">
                    <label for="exampleInputName">Paragraph 1</label>
                    <input maxlength="35" name="paragraph1" class="form-control"type="text" value="<?php echo $announcementdata['announcement1'];?>">
                </div>
                <div class="col-md-6">
                    <label for="exampleInputLastName">Paragraph 2</label>
                    <input maxlength="30" name="paragraph2" class="form-control"type="text" value="<?php echo $announcementdata['announcement2'];?>">
                </div>
                </div>
            </div>
            <button class="btn btn-primary btn-block" name="announcement-update" type="submit"><i class="fa fa-fw fa-pencil"></i> Update</button>
            </form>
        </div>
      </div>
    </div>
