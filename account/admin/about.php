    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POSt">
                <?php
                    $about=mysqli_query($mysqli, $querryabout) or die(mysqli_error);
                    $aboutdata = mysqli_fetch_array($about)
                ?>
            <div class="form-group">
                <label>Paragraph 1</label>
                <textarea rows="5" name="paragraph1" class="form-control"><?php echo $aboutdata['paragraph1'];?></textarea>
            </div>
            <div class="form-group">
                <label>Paragraph 2</label>
                <textarea rows="5" name="paragraph2" class="form-control"><?php echo $aboutdata['paragraph2'];?></textarea>
            </div>
            <div class="form-group">
                <label>Paragraph 3</label>
                <textarea rows="5" name="paragraph3" class="form-control"><?php echo $aboutdata['paragraph3'];?></textarea>
            </div>
            <button class="btn btn-primary btn-block" name="about-update" type="submit"><i class="fa fa-fw fa-pencil"></i> Update</button>
            </form>
        </div>
      </div>
    </div>
